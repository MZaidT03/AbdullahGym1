...
export function FloatingWhatsapp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[90] flex items-center gap-3 bg-[#25D366] hover:bg-[#20ba5a] text-white p-3.5 sm:px-5 sm:py-3.5 rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.4)] border border-emerald-300/40 hover:scale-105 active:scale-95 transition-all duration-300 group cursor-pointer"
    >
      {/* WhatsApp SVG Icon */}
